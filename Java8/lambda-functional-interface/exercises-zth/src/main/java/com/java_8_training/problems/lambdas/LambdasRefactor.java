...
public class LambdasRefactor {
    ...
    public static List<Apple> sortInventoryByDecreasingWeight() {
        ...
        List<Apple> inventory = asList(new Apple(80, "green"), new Apple(155, "green"),
                new Apple(120, "red"));
...
//        });
        ...
        String desColor = "green";
        List<Apple> greenApples = filterApples(inventory, apple -> apple.getColor().equals(desColor));
