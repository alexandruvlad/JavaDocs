import exercise.exercise4.CastException;
...
public class Exercise4Test {
    ...
    @Test
    public void testRemoveMethodOverStringList() throws CastException {
        testingStringValues.remove(1);
        Assert.assertTrue(testingStringValues.size() == 5);
    }

    @Test
    public void testIsEmptyMethodOverIntegerList() throws CastException {
        //@TODO use Iterator and remove the classic for

        for (Iterator<Integer> it = testingIntegerValues.iterator(); it.hasNext(); ) {
            Integer i = it.next();
    ...
    @Test
    public void testGetMethodOverIntegerList() throws CastException {
        Assert.assertTrue(testingIntegerValues.get(1).compareTo(1) == 0);
    }

    @Test
    public void testSetMethodOverStringList() throws CastException {
